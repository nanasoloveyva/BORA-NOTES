...
- Возможность форматирования текста через горячие клавиши или через меню быстрого доступа (правая клавиша мыши).
...
- Сортировка списка всех записей (по алфавиту, времени создания или времени последнего редактирования файла)
